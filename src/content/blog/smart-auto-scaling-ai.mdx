...
description: "CPU autoscaling is a lie for GPU workloads. Why queue depth, KV-cache pressure, and TTFT beat CPU as scaling triggers — KEDA-driven patterns, ARIMA forecasting, and composite metrics that scale your AI SaaS before users hit the spinner."
publishDate: 2026-05-25
category: architecture
tags: [auto-scaling, ai, llm, kubernetes, keda, gpu, kv-cache, queue-depth, ttft, infrastructure]
featured: false
heroImage:
