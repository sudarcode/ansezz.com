...
description: "Naive chunking, no reranker, embedding drift, latency blowups, vibe-checking — the seven structural mistakes that turn a slick RAG demo into a production nightmare, and the fixes that actually ship."
publishDate: 2026-05-17
category: ai
tags: [rag, ai, llm, pgvector, reranker, hybrid-search, evals, production]
featured: true
heroImage:
  url: "https://cdn.marblism.com/3rVZwAAEjp-.webp"
...
![Structural vs naive chunking illustration](https://cdn.marblism.com/on3xgCmaGCz.webp)
...
![Two-stage retrieval with reranker](https://cdn.marblism.com/4p7rDMF4Alq.webp)
...
![Latency budget illustration](https://cdn.marblism.com/GIkH9gaCAEu.webp)
...
![Evaluation harness illustration](https://cdn.marblism.com/1vTHAMhrMRt.webp)
