...
description: "Why this site exists, what I'll write about, and why neobrutalism is the right call for an engineer's portfolio in 2026."
...
I've spent 10+ years remote, mostly head-down in client codebases. The patterns I keep
reaching for — Laravel Octane at scale, RAG done right, agentic commerce — don't show up
in tutorials. So I'm writing them down.
...
<ComparisonTable
  ...
  rows={[
    { icon: "lucide:check", label: "Real production code", cells: [true, false] },
...
<BurstBadge tone="pink" size="sm">01</BurstBadge>
