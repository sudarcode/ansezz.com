...
tags: [redis, caching, ai, rag, semantic-cache, redisvl, vector-search, performance, infrastructure]
featured: false
heroImage:
...
2. **Semantic cache** — if the exact cache misses, I embed the query and look for "near enough" matches in a Redis vector index. If I find a previous question with a similarity score of 0.95 or higher, I serve that cached response instead of hitting the LLM.
